    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                <h3>Lihat Data Dokumen Pembiayaan VCO Kaper</h3>
                <a href="home?par=lihathasil&par2=pembiayaan" target="_blank"><i class="fa fa-eye"></i> Lihat Hasil Approval</a>
                &nbsp;&nbsp;
                <!-- <a href="#" ><i class="fa fa-comments"></i> Chat Whatsapp (0)</a> -->
                <a href="#" onclick="window.open('mod_whatsapp/pilihchat?par=&par2=<?php echo $username;?>&par3=','','width=800, height=480, top=5, left=150, scrollbars=yes');"><i class="fa fa-comments"></i> Chat Whatsapp</a>
            </header>
            <div class="panel-body">
                  <div class="adv-table">
                    <form method="post" action="mod_kaper_vco/dolihatdatapembiayaan.php">
                    ...
                    <br><br>
                      <table  class="display table table-bordered table-striped" style="font-size: 10px;">
                        ...
                        <?php
                            ...
                            acc_monitoring.validasi_vco is NULL  ";
