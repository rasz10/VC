<?php
	...
	for($i=0; $i<$NANO; $i++){
		if ($status[$i] != "-") {
			...
			$monitoring = "UPDATE acc_monitoring SET validasiproposal_kabag_korporasi='$status[$i]',user_validasiproposal_kabag_korporasi='$user[$i]"."|"."$date[$i]',note_validasiproposal_kabag_korporasi='$catatan[$i]' where iddebitur='$iddebitur[$i]'";
			// echo $monitoring."<br>";
