<?php
	...
	for($i=0; $i<$NANO; $i++){
		if ($status[$i] != "-") {
			...
			$monitoring = "UPDATE acc_monitoring SET approve_kadiv_kdo='$status[$i]',user_approve_kadiv_kdo='$user[$i]"."|"."$date[$i]',note_approve_kadiv_kdo='$catatan[$i]' where iddebitur='$iddebitur[$i]'";
			// echo $monitoring."<br>";
