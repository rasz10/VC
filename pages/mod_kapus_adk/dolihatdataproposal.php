<?php
	...
	for($i=0; $i<$NANO; $i++){
		if ($status[$i] != "-") {
			...
			$monitoring = "UPDATE acc_monitoring SET verifikasiproposal_adk='$status[$i]',user_verifikasiproposal_adk='$user[$i]"."|"."$date[$i]',note_verifikasiproposal_adk='$catatan[$i]' where iddebitur='$iddebitur[$i]'";
			// echo $monitoring."<br>";
