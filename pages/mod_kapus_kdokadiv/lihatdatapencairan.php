    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                <h3>Lihat Data Dokumen Pencairan Kadiv KDO Kapus</h3>
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div id="kaper" class="tab-pane active">
                                <div class="adv-table">
                                    <form method="post" action="mod_kapus_kdokadiv/dolihatdatapencairan.php">
                                      ...
                                      <table class="display table table-bordered table-striped" style="font-size: 10px;">
                                        ...
                                        <?php
                                            $query= "SELECT * FROM acc_master_debitur INNER JOIN acc_monitoring ON acc_master_debitur.iddebitur=acc_monitoring.iddebitur where 
                                                ...
                                                acc_monitoring.verifikasiproposal_adk = '1' and 
                                                acc_monitoring.uploadpencairan_sko  = '1' and 
                                                acc_monitoring.validasipencairan_legal = '1' and 
                                                acc_monitoring.validasipencairan_kakaper = '1' and 
                                                acc_monitoring.verifikasipencairan_kdo_legal = '1' and 
                                                acc_monitoring.verifikasipencairan_kdo_keuangan = '1' and 
                                                acc_monitoring.approve_kadiv_kdo is NULL ";
                                        ...
                                        ?>
                                            <tr class="gradeX">
                                                ...
                                                <td>
                                                    <a href="../upload/dok_pencairan/dok_pk/<?php echo $data['dok_pk'];?>" target="_blank"><b>PK&nbsp;:&nbsp;</b><?php echo $data['dok_pk'];?></a><br><br>
                                                    <a href="../upload/dok_pencairan/dok_covernote/<?php echo $data['dok_covernote'];?>" target="_blank"><b>Covernote&nbsp;:&nbsp;</b><?php echo $data['dok_covernote'];?></a><br><br>
                                                    <a href="../upload/dok_pencairan/dok_mpd/<?php echo $data['dok_mpd'];?>" target="_blank"><b>MPD&nbsp;:&nbsp;</b><?php echo $data['dok_mpd'];?></a>
                                                </td>
                                                <td align="center">
                                                    <?php echo $data['nama_bank'];?><br>
                                                    <?php echo $data['atasnama_bank'];?><br>
                                                    <?php echo $data['no_rekening'];?><br><br>
                                                    <b><?php echo $data['cuser_rekening'];?><br>
                                                    <?php echo $data['cdate_rekening'];?><br></b>
                                                </td>
                                                <td>
                                                    <select name="status[]">
                                    ...
                                    <br><br>
                                      <table class="display table table-bordered table-striped" style="font-size: 10px;">
                                        ...
                                        <?php
                                            ...
                                            acc_monitoring.verifikasiproposal_adk = '1' and 
                                            acc_monitoring.uploadpencairan_sap = '1' and 
                                            acc_monitoring.validasipencairan_kabag_korporasi = '1' and 
                                            acc_monitoring.verifikasipencairan_kdo_legal = '1' and 
                                            acc_monitoring.verifikasipencairan_kdo_keuangan = '1' and 
                                            acc_monitoring.approve_kadiv_kdo is NULL ";
