            ...
            <div class="panel-body">
                  <div class="adv-table">
                      <table  class="display table table-bordered table-striped" id="example">
                        ...
                        <tbody>
                        <?php
                            $query= "SELECT * FROM acc_master_debitur where statussslikf is not NULL order by no desc";
                        ...
                        <tr class="gradeX">
                             <td><?php echo $no;?></td>
                                ...
                                <td>
                                    <?php echo $data['catatanslik'];?>
                                </td>
                                <td>
                                    <a href="#" onclick="window.open('mod_slik/editdataslik?par=<?php echo $iddebitur;?>&par2=<?php echo $data['nama'];?>','','width=800, height=480, top=5, left=150, scrollbars=yes');" style="width: 100px;" ><i class="fa fa-edit"></i> Edit</a>
                                </td>
                        </tr>
                        <?php $no++;} ?>
                        </tbody>
