    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                <h3>Lihat Data Dokumen Pembiayaan Kakaper Kaper</h3>
                <a href="home?par=lihathasil&par2=pembiayaan" target="_blank"><i class="fa fa-eye"></i> Lihat Hasil Approval</a>
            </header>
            <div class="panel-body">
                  <div class="adv-table">
                    <form method="post" action="mod_kaper_kakaper/dolihatdatapembiayaan.php">
                    ...
                    <br><br>
                      <table  class="display table table-bordered table-striped" style="font-size: 10px;">
                        ...
                        <?php
                            ...
                            acc_monitoring.validasi_kakaper is NULL  ";
