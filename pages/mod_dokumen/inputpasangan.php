<?php
  ...
  $getjumlahpasangan = getjumlahpasangan($conn,$iddebitur);
  $jumlahpasangan = $getjumlahpasangan + 1;
?>

<section class="panel">
  <header class="panel-heading">
      <h3>Input Data Pasangan ke <?php echo $jumlahpasangan; ?></h3>
  </header>
      ...
      <form role="form" class="form-upload-pasangan-perseorangan">
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <input type="hidden" class="idpasangan" name="idpasangan">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            <a href='home?par=inputpasangan&par2=<?php echo $iddebitur;?>' class='btn btn-default modal-perorangan-tambah-penjamin'><i class='fa fa-plus'></i> <font color="red">Tambah Data Pasangan</font></a>
          </div>
        </div>
      </form>
    </div>
