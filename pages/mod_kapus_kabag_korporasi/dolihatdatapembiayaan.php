                  ...
                  <div class="adv-table">
                      <table  class="display table table-bordered table-striped" id="example">
                        ...
                        <tr>
                            ...
                            <th>Status SID<br>Catatan SID</th>
                        ...
                        <?php
                            ...
                            acc_master_debitur.statussidf = '1' and 
                        ...
                        <tr class="gradeX">
                             <td><?php echo $no;?></td>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <?php echo $status;?><br><br><a href="../upload/dok_sid/<?php echo $data['upload_by_sid'];?>" target="_blank"><?php echo $data['upload_by_sid'];?></a><br><br><?php echo $data['catatansid'];?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="#"></i> Edit</a>
                                    <!-- onclick="window.open('mod_sid/editdatasid?par=<?php echo $iddebitur;?>&par2=<?php echo $data['nama'];?>','','width=800, height=480, top=5, left=150, scrollbars=yes');" style="width: 100px;" ><i class="fa fa-edit" -->
                                </td>
                        </tr>
                        <?php $no++;} ?>
                        </tbody>
