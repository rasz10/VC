    ...
    <div class="col-lg-12">
        <section class="panel">
            <header class="panel-heading">
                <h3>Lihat Data Dokumen Pembiayaan Reviewer Kantor Pusat</h3>
                <a href="home?par=lihathasil&par2=pembiayaan" target="_blank"><i class="fa fa-eye"></i> Lihat Hasil Approval</a>
                <!-- &nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="window.open('mod_whatsapp/whatsapp','','width=800, height=480, top=5, left=150, scrollbars=yes');"><i class="fa fa-comments"></i> Chat Whatsapp</a> -->
            </header>
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                <div id="kaper" class="tab-pane active">
                                    <div class="adv-table">
                                       <form method="post" action="mod_kapus_reviewer/dolihatdata.php">
                                          ...
                                          <table  class="display table table-bordered table-striped" style="font-size: 10px;">
                                            ...
                                            <?php
                                                $query= "SELECT * FROM acc_master_debitur INNER JOIN acc_monitoring ON acc_master_debitur.iddebitur=acc_monitoring.iddebitur where 
                                                    ...
                                                    acc_monitoring.pengolahan_reviewer is NULL  ";
                                            ...
                                            ?>
                                                <tr class="gradeX">
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-success" onclick="window.open('mod_whatsapp/whatsapp?par=<?php echo $iddebitur;?>&par2=<?php echo $username;?>&par3=<?php echo $register;?>&par4=<?php echo $username;?>&par5=','','width=800, height=480, top=5, left=150, scrollbars=yes');" style="font-size: 9px;"><i class="fa fa-comments"></i> Chat<br>Whatsapp</a>
                                          ...
                                          <table  class="display table table-bordered table-striped" style="font-size: 10px;">
                                            ...
                                            ?>
                                                <tr class="gradeX">
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-success" onclick="window.open('mod_whatsapp/whatsapp?par=<?php echo $iddebitur;?>&par2=<?php echo $username;?>&par3=<?php echo $register;?>','','width=800, height=480, top=5, left=150, scrollbars=yes');" style="font-size: 9px;"><i class="fa fa-comments"></i> Chat<br>Whatsapp</a>
                                                        <!-- <button type="submit" class="btn btn-success" style="font-size: 9px;" ><i class="fa fa-check"></i> Update</button> -->
                                                        <!-- onclick="return confirm('Anda Yakin Update Data ini??')" -->
                                                    </td>
                                                </tr>
